...
(function (root, factory) {
  ...
  var RULES = [
    ...
    'Threads stay readable in the archive for next season\'s candidates, so write for ' +
      'them too. Your own post is yours to edit and to delete at any time while the ' +
      'season is running; a deleted post\'s words are gone for good. A reply keeps its ' +
