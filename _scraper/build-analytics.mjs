...
/** Google Analytics 4, through the Data API.
    ...
    server-side function performs, which is where the figures come from now. */
...
async function main() {
  ...
  const data = assemble(results, {
    ...
    carry: {
      ...
      /* the WHOLE previous block, not just its rows: it carries the range,
         the frozen flag and the coverage counts, and a carry that dropped
         them would republish a live section as an archive */
